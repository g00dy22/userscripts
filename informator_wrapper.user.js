...
(function() {
    ...
    function page_ads() {
        ...
        var t_ckeywords = [
		"КаВуН", "КавуН", "советы эксперта", "сегодня праздник", "футбол", ": какой сегодня день",
                ...
                "как выглядит", "Как выглядит", "Сонный Днепр:"
        ]
        var t_skeywords = ["ТОП"]
        ...
        var p_keywords = [
		"Ранее мы","Ранее Информатор","быть в курсе всех","SOHO","Хотите узнавать первым",
        ...
        var p_skeywords = [
		"Ранее сообщалось, что", "Напомним, что", "Вы можете посмотреть,", "Авто Информатор рассказывал,",
                "Мы сообщали о том, что", "Ранее Информатор", "Напомним, ранее мы сообщали",
                "Больше новостей — в нашем", "Раннее мы сообщали", "Раннее мы рассказывал"
        ]
